...
namespace TP_Integrador
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //}
            //
            //Map myMap = Map.GetInstance(15, 15);
            //Quarter quarterLoc = myMap.GetQuarterLocations().First();
            //Location destiny = myMap.GetLocationInMap(13, 3);
            //K9 op = new K9(1, 30, quarterLoc);
            //M8 op2 = new M8(1, 30, quarterLoc);
            //UAV op3 = new UAV(1,30, quarterLoc);

            //#region Show Map
            //myMap.PrintMap();
            //myMap.DebugTypesPorcentages();
            //#endregion

            //Console.WriteLine($"{op.GetType()}");
            //Console.WriteLine(op.ToString());            
            //op.Travel(destiny, myMap, false);            
            //Console.WriteLine(op.ToString());

            //Console.WriteLine($"{op2.GetType()}");
            //Console.WriteLine(op2.ToString());
            //op2.Travel(destiny, myMap, false);
            //Console.WriteLine(op2.ToString());

            //Console.WriteLine($"{op3.GetType()}");
            //Console.WriteLine(op3.ToString());
            //op3.Travel(destiny, myMap, true);
            //Console.WriteLine(op3.ToString());

            Map map = Map.GetInstance(15,15);
